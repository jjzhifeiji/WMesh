...
import { useCopyFSNode, useCreateFSFolder, useDeleteFSNode, useFS, useMoveFSNode, useRenameFSNode, type FSNode } from "./api";
...
function canCopyNode(n: FSNode) {
  ...
  if (n.nodeKind === "file" && n.asset && !n.asset.copyable) return false;
  return true;
}
