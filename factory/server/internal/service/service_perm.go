...
func (s *Service) CreatePerson(ctx context.Context, token, loginName, displayName string) (Account, string, error) {
...
func (s *Service) ReparentOrgUnit(ctx context.Context, token string, unitID uuid.UUID, parentID *uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) AddParent(ctx context.Context, token string, unitID, parentID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) Assign(ctx context.Context, token string, personID, unitID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) Unassign(ctx context.Context, token string, personID, unitID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) GrantRole(ctx context.Context, token string, personID uuid.UUID, role, scopeKind string, orgUnitID *uuid.UUID) (RoleGrant, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
...
func (s *Service) RevokeRole(ctx context.Context, token string, grantID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) Operate(ctx context.Context, token string, unitID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) ViewOrg(ctx context.Context, token string, unitID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) DisableOrgUnit(ctx context.Context, token string, unitID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
