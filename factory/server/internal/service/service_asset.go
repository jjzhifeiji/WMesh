...
func (s *Service) canAuthorFactory(ctx context.Context, acc Account, unit *uuid.UUID) error {
...
func (s *Service) resolveAuthorContext(ctx context.Context, acc Account, wc WorkContext) (*uuid.UUID, []PathNode, error) {
...
func (s *Service) insertAuthored(ctx context.Context, acc Account, wc WorkContext, kind, level, name string, content []byte, deps []AssetDep) (Asset, error) {
...
func (s *Service) CreateFactoryProcess(ctx context.Context, token string, wc WorkContext, name string, content []byte) (Asset, error) {
...
func (s *Service) CreatePersonalProcess(ctx context.Context, token string, wc WorkContext, name string, content []byte) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) CreatePersonalProject(ctx context.Context, token string, wc WorkContext, name string, content []byte, deps []AssetDep) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) assertPersonalProjectDeps(ctx context.Context, acc Account, deps []AssetDep) error {
	for _, d := range deps {
...
func (s *Service) CreateFactoryProject(ctx context.Context, token string, wc WorkContext, name string, content []byte, deps []AssetDep) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) CreatePlatformProcess(ctx context.Context, token string, name string, content []byte) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) RenameAsset(ctx context.Context, token string, assetID uuid.UUID, expected int64, name string) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) UpdateAssetContent(ctx context.Context, token string, assetID uuid.UUID, expected int64, content []byte) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) SetAssetCopyable(ctx context.Context, token string, assetID uuid.UUID, expected int64, copyable bool) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
// PublishAsset 草稿改为可用。
func (s *Service) PublishAsset(ctx context.Context, token string, assetID uuid.UUID, expected int64) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) DisableAsset(ctx context.Context, token string, assetID uuid.UUID, expected int64) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) ReenableAsset(ctx context.Context, token string, assetID uuid.UUID, expected int64) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
// DeleteAsset 拒绝物理删除。
func (s *Service) DeleteAsset(ctx context.Context, token string, assetID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) mutateAsset(ctx context.Context, acc Account, assetID uuid.UUID, expected int64, action string, patch func(Asset) (store.AssetWrite, error)) (Asset, error) {
...
func (s *Service) canViewAssetMeta(ctx context.Context, acc Account, a Asset) error {
...
func (s *Service) GetAsset(ctx context.Context, token string, assetID uuid.UUID) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) ReadAssetContent(ctx context.Context, token string, assetID uuid.UUID) ([]byte, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return nil, err
	}
...
func (s *Service) PromoteToFactory(ctx context.Context, token string, assetID uuid.UUID) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
...
func (s *Service) assertPromoteToFactoryDeps(ctx context.Context, src Asset) error {
...
func (s *Service) ExportAssetSnapshot(ctx context.Context, token string, assetID uuid.UUID) (AssetSnapshot, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
...
func (s *Service) CreateProcessFromProject(ctx context.Context, token string, projectID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
