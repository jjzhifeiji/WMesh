...
func (s *Service) AcceptPlatformDelivery(ctx context.Context, snap ClosureSnapshot) error {
...
func (s *Service) GrantClientProject(ctx context.Context, token string, projectID, clientID uuid.UUID) error {
...
func (s *Service) RevokeClientProject(ctx context.Context, token string, projectID, clientID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) assertGrantableProject(ctx context.Context, projectID uuid.UUID) error {
...
func (s *Service) SetCacheLimit(ctx context.Context, token string, n int) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) DistributeToClient(ctx context.Context, token string, projectID, clientID uuid.UUID, bag *Bag, clocks Clocks) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) assertClientRuntime(ctx context.Context, clientID uuid.UUID, clocks Clocks) error {
...
func (s *Service) CachePersonalProject(ctx context.Context, token string, projectID, clientID uuid.UUID, bag *Bag, clocks Clocks) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) ForwardToFactory(ctx context.Context, token string, assetID, factoryID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) SetReplicaCopyable(ctx context.Context, token string, assetID uuid.UUID, copyable bool) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) PromoteReplica(ctx context.Context, token string, assetID uuid.UUID) error {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return err
	}
...
func (s *Service) ListReplicas(ctx context.Context, token string) ([]AssetReplica, error) {
...
func (s *Service) GetReplica(ctx context.Context, token string, assetID uuid.UUID, revision int64) (AssetReplica, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
...
func (s *Service) canViewReplica(ctx context.Context, acc Account) error {
