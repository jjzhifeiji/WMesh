...
func (s *Service) EnqueueFact(ctx context.Context, bag *Bag, clocks Clocks, loginName, password string, wc WorkContext) (PendingFact, error) {
...
func (s *Service) EnqueueUpload(ctx context.Context, bag *Bag, clocks Clocks, loginName, password, kind string, content []byte) (PendingUpload, error) {
	src := bagTimeSource(*bag)
	if err := s.assertBagFactory(*bag); err != nil {
...
func (s *Service) ConvergeIntent(ctx context.Context, bag *Bag) error {
	src := bagTimeSource(*bag)
...
func (s *Service) FlushPending(ctx context.Context, bag *Bag) error {
	src := bagTimeSource(*bag)
...
func (s *Service) Reconnect(ctx context.Context, bag *Bag) error {
...
func (s *Service) GetUpload(ctx context.Context, token string, uploadID uuid.UUID) (UploadRecord, error) {
...
func (s *Service) ReadUploadContent(ctx context.Context, token string, uploadID uuid.UUID) ([]byte, error) {
...
func (s *Service) mergeOneUpload(ctx context.Context, bag Bag, item PendingUpload) error {
...
func (s *Service) assertBagFactory(bag Bag) error {
...
func (s *Service) assertOnlineBag(ctx context.Context, bag Bag) error {
	if err := s.assertBagFactory(bag); err != nil {
		return err
	}
	if !bag.Connected {
