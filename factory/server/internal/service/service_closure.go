...
func (s *Service) loadDepMember(ctx context.Context, d AssetDep) (ClosureMember, error) {
...
func (s *Service) packFromMember(ctx context.Context, root ClosureMember) (ClosureSnapshot, error) {
...
func (s *Service) loadRootForPack(ctx context.Context, assetID uuid.UUID) (ClosureMember, error) {
...
func (s *Service) auditPack(ctx context.Context, actor *uuid.UUID, snap ClosureSnapshot, result string) error {
...
func (s *Service) AssembleProject(ctx context.Context, token string, assetID uuid.UUID) (ClosureSnapshot, error) {
...
func (s *Service) canPack(ctx context.Context, acc Account, root ClosureMember) error {
...
func (s *Service) isFactoryScopePE(ctx context.Context, acc Account) bool {
...
func (s *Service) putCached(ctx context.Context, bag *Bag, snap ClosureSnapshot) error {
	if err := validateClosure(snap); err != nil {
		return err
	}
...
func (s *Service) AcceptCachedClosure(ctx context.Context, bag *Bag, snap ClosureSnapshot) error {
...
func (s *Service) UncacheProject(ctx context.Context, bag *Bag, projectID uuid.UUID) error {
	if bag.Welding {
...
func (s *Service) ActivateProject(ctx context.Context, bag *Bag, clocks Clocks, projectID uuid.UUID) error {
...
func (s *Service) assertSourceAvailable(ctx context.Context, root ClosureMember) error {
	if root.Level == AssetLevelPlatform {
...
func (s *Service) SetProjectDeps(ctx context.Context, token string, assetID uuid.UUID, expected int64, deps []AssetDep) (Asset, error) {
	acc, err := s.RequireActive(ctx, token)
	if err != nil {
		return Asset{}, err
	}
