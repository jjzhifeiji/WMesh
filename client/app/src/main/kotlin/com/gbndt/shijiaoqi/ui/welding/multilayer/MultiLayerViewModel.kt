        ...
        val newPoints = basePath.points.mapIndexed { index, point ->
            ...
            if (point.type != WeldPointType.START_SAFE && point.type != WeldPointType.END_SAFE) {
                 ...
                 if (multiPath.refPointX1 != null && multiPath.refPointZ1 != null &&
                     ...
                     val dcddA = com.gbndt.shijiaoqi.domain.weld.DcddPoint(originA.x, originA.y, originA.z)
                     val dcddB = com.gbndt.shijiaoqi.domain.weld.DcddPoint(refX.pose.x, refX.pose.y, refX.pose.z)
                     val dcddC = com.gbndt.shijiaoqi.domain.weld.DcddPoint(refZ.pose.x, refZ.pose.y, refZ.pose.z)
                     val coordSys = com.gbndt.shijiaoqi.domain.weld.DcddCoordinateSystem(dcddA, dcddB, dcddC)
